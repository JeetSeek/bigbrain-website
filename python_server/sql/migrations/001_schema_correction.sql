-- Migration 001: Corrects initial database schema based on architectural blueprint.

BEGIN;

-- 1. Rename 'boilers' to 'boiler_manuals' and update column names for clarity.
ALTER TABLE public.boilers RENAME TO boiler_manuals;
...
CREATE TABLE IF NOT EXISTS public.repair_histories (
    ...
    fault_code_id INT REFERENCES public.boiler_fault_codes(id),
